...
declare namespace ResourceControllerV2 {
    ...
    /** The status of the last operation requested on the instance. */
    interface ResourceInstanceLastOperation {
    ...
    class ResourceInstancesPager {
         ...
         */
        constructor(client: ResourceControllerV2, params?: ResourceControllerV2.ListResourceInstancesParams);
        /**
    ...
    class ResourceAliasesForInstancePager {
         ...
         */
        constructor(client: ResourceControllerV2, params: ResourceControllerV2.ListResourceAliasesForInstanceParams);
        /**
         * Returns true if there are potentially more results to be retrieved by invoking getNext().
         * @returns {boolean}
         */
    ...
    class ResourceKeysForInstancePager {
         ...
         */
        constructor(client: ResourceControllerV2, params: ResourceControllerV2.ListResourceKeysForInstanceParams);
        /**
         * Returns true if there are potentially more results to be retrieved by invoking getNext().
         * @returns {boolean}
         */
    ...
    class ResourceKeysPager {
         ...
         */
        constructor(client: ResourceControllerV2, params?: ResourceControllerV2.ListResourceKeysParams);
        /**
         * Returns true if there are potentially more results to be retrieved by invoking getNext().
         * @returns {boolean}
         */
    ...
    class ResourceBindingsPager {
         ...
         */
        constructor(client: ResourceControllerV2, params?: ResourceControllerV2.ListResourceBindingsParams);
        /**
         * Returns true if there are potentially more results to be retrieved by invoking getNext().
         * @returns {boolean}
         */
    ...
    class ResourceAliasesPager {
         ...
         */
        constructor(client: ResourceControllerV2, params?: ResourceControllerV2.ListResourceAliasesParams);
        /**
         * Returns true if there are potentially more results to be retrieved by invoking getNext().
         * @returns {boolean}
         */
    ...
    class ResourceBindingsForAliasPager {
         ...
         */
        constructor(client: ResourceControllerV2, params: ResourceControllerV2.ListResourceBindingsForAliasParams);
        /**
         * Returns true if there are potentially more results to be retrieved by invoking getNext().
         * @returns {boolean}
         */
