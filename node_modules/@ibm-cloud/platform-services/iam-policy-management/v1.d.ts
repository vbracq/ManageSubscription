...
declare class IamPolicyManagementV1 extends BaseService {
     ...
     * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.EmptyObject>>}
     */
    deletePolicyTemplate(params: IamPolicyManagementV1.DeletePolicyTemplateParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.EmptyObject>>;
    /**
     ...
     * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyTemplateLimitData>>}
     */
    createPolicyTemplateVersion(params: IamPolicyManagementV1.CreatePolicyTemplateVersionParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyTemplateLimitData>>;
    /**
     ...
     */
    listPolicyTemplateVersions(params: IamPolicyManagementV1.ListPolicyTemplateVersionsParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyTemplateVersionsCollection>>;
    /**
     ...
     * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyTemplate>>}
     */
    replacePolicyTemplate(params: IamPolicyManagementV1.ReplacePolicyTemplateParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyTemplate>>;
    /**
     ...
     * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.EmptyObject>>}
     */
    deletePolicyTemplateVersion(params: IamPolicyManagementV1.DeletePolicyTemplateVersionParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.EmptyObject>>;
    /**
     ...
     * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyTemplate>>}
     */
    getPolicyTemplateVersion(params: IamPolicyManagementV1.GetPolicyTemplateVersionParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyTemplate>>;
    /**
     ...
     * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.EmptyObject>>}
     */
    commitPolicyTemplate(params: IamPolicyManagementV1.CommitPolicyTemplateParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.EmptyObject>>;
    /*************************
     * policyAssignments
     ************************/
    /**
     ...
     */
    listPolicyAssignments(params: IamPolicyManagementV1.ListPolicyAssignmentsParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyTemplateAssignmentCollection>>;
    /**
     ...
     */
    getPolicyAssignment(params: IamPolicyManagementV1.GetPolicyAssignmentParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyAssignment>>;
}
/*************************
 * interfaces
 ************************/
declare namespace IamPolicyManagementV1 {
    ...
    interface UpdatePolicyStateParams {
        /** The policy ID. */
        policyId: string;
        /** The revision number for updating a policy and must match the ETag value of the existing policy. The Etag can
         *  be retrieved using the GET /v1/policies/{policy_id} API and looking at the ETag response header.
    ...
    namespace UpdatePolicyStateConstants {
        /** The policy state. */
        enum State {
            ACTIVE = "active",
            DELETED = "deleted"
    ...
    interface ListV2PoliciesParams {
    ...
    namespace ListV2PoliciesConstants {
        /** Optional type of policy. */
        enum Type {
            ACCESS = "access",
            AUTHORIZATION = "authorization"
    ...
    interface CreateV2PolicyParams {
    ...
    namespace CreateV2PolicyConstants {
        /** The policy type; either 'access' or 'authorization'. */
        enum Type {
            ACCESS = "access",
            AUTHORIZATION = "authorization"
    ...
    interface ReplaceV2PolicyParams {
        /** The policy ID. */
        id: string;
        /** The revision number for updating a policy and must match the ETag value of the existing policy. The Etag can
    ...
    namespace ReplaceV2PolicyConstants {
        /** The policy type; either 'access' or 'authorization'. */
        enum Type {
            ACCESS = "access",
            AUTHORIZATION = "authorization"
    ...
    namespace GetV2PolicyConstants {
    ...
    interface DeleteV2PolicyParams {
        /** The policy ID. */
        id: string;
        headers?: OutgoingHttpHeaders;
    }
    /** Parameters for the `listPolicyTemplates` operation. */
    interface ListPolicyTemplatesParams {
    ...
    interface CreatePolicyTemplateParams {
    ...
    interface ListPolicyTemplateVersionsParams {
        /** The policy template ID. */
        policyTemplateId: string;
        headers?: OutgoingHttpHeaders;
    }
    /** Parameters for the `replacePolicyTemplate` operation. */
    interface ReplacePolicyTemplateParams {
        /** The policy template ID. */
        policyTemplateId: string;
    ...
    interface DeletePolicyTemplateVersionParams {
        /** The policy template ID. */
        policyTemplateId: string;
        /** The policy template version. */
        version: string;
    ...
    interface GetPolicyTemplateVersionParams {
        /** The policy template ID. */
        policyTemplateId: string;
        /** The policy template version. */
        version: string;
    ...
    interface CommitPolicyTemplateParams {
        /** The policy template ID. */
        policyTemplateId: string;
        /** The policy template version. */
        version: string;
    ...
    interface ListPolicyAssignmentsParams {
        /** The account GUID in which the policies belong to. */
        accountId: string;
        /** Language code for translations
         *  * `default` - English
    ...
    interface GetPolicyAssignmentParams {
    ...
    interface AssignmentResourceCreated {
        /** policy id. */
        id?: string;
    }
    /** Details of conflicting resource. */
    interface ConflictsWith {
    ...
    interface GrantWithEnrichedRoles {
    ...
    interface PolicyAssignmentOptions {
    ...
    namespace PolicyAssignmentOptions {
        namespace Constants {
            /** The policy subject type; either 'iam_id' or 'access_group_id'. */
            enum SubjectType {
                IAM_ID = "iam_id",
    ...
    interface PolicyAssignmentResourcePolicy {
        /** On success, includes the  policy assigned. */
    ...
    interface PolicyAssignmentResources {
    ...
    interface PolicyTemplateAssignmentCollection {
        /** List of policy assignments. */
        assignments?: PolicyAssignment[];
    }
    /** A collection of policy Templates. */
    interface PolicyTemplateCollection {
        /** List of policy templates. */
        policy_templates?: PolicyTemplate[];
    }
    /** The core set of properties associated with the policy template. */
    interface PolicyTemplateLimitData {
        /** Required field when creating a new template. Otherwise this field is optional. If the field is included it
         *  will change the name value for all existing versions of the template.
         */
        name: string;
    ...
    /** The core set of properties associated with a policy. */
    interface PolicyTemplateMetaData {
        /** The policy ID. */
        id?: string;
        /** The policy type; either 'access' or 'authorization'. */
        type: string;
    ...
    namespace PolicyTemplateMetaData {
        namespace Constants {
            /** The policy state. */
            enum State {
                ACTIVE = "active",
    ...
    interface PolicyTemplateVersionsCollection {
    ...
    /** A collection of policies. */
    interface V2PolicyCollection {
        /** List of policies. */
        policies?: V2PolicyTemplateMetaData[];
    }
    /** The resource attributes to which the policy grants access. */
    interface V2PolicyResource {
    ...
    interface V2PolicyResourceAttribute {
    ...
    namespace V2PolicyResourceAttribute {
        namespace Constants {
            /** The operator of an attribute. */
            enum Operator {
    ...
    /** Additional access conditions associated with the policy. */
    interface V2PolicyRule {
    }
    /** The subject attributes for whom the policy grants access. */
    interface V2PolicySubject {
    ...
    interface V2PolicySubjectAttribute {
    ...
    namespace V2PolicySubjectAttribute {
        namespace Constants {
            /** The operator of an attribute. */
            enum Operator {
                STRINGEQUALS = "stringEquals"
    ...
    /** The core set of properties associated with the policy. */
    interface V2PolicyTemplateMetaData {
        /** The policy type; either 'access' or 'authorization'. */
    ...
    namespace V2PolicyTemplateMetaData {
        namespace Constants {
            /** The policy type; either 'access' or 'authorization'. */
            enum Type {
                ACCESS = "access",
    ...
    /** Specifies the type of access granted by the policy. */
    interface ControlResponseControl extends ControlResponse {
        /** Permission granted by the policy. */
        grant: Grant;
    }
    /** Specifies the type of access granted by the policy with additional role information. */
    interface ControlResponseControlWithEnrichedRoles extends ControlResponse {
        /** Permission granted by the policy with translated roles and additional role information. */
        grant: GrantWithEnrichedRoles;
    }
    /** Rule that specifies additional access granted (e.g., time-based condition). */
    interface NestedConditionRuleAttribute extends NestedCondition {
        /** The name of an attribute. */
        key: string;
        /** The operator of an attribute. */
    ...
    namespace NestedConditionRuleAttribute {
        namespace Constants {
            /** The operator of an attribute. */
            enum Operator {
                TIMELESSTHAN = "timeLessThan",
    ...
    interface NestedConditionRuleWithConditions extends NestedCondition {
    ...
    namespace NestedConditionRuleWithConditions {
        namespace Constants {
            /** Operator to evaluate conditions. */
            enum Operator {
                AND = "and",
    ...
    /** Rule that specifies additional access granted (e.g., time-based condition). */
    interface V2PolicyRuleRuleAttribute extends V2PolicyRule {
        /** The name of an attribute. */
        key: string;
        /** The operator of an attribute. */
    ...
    namespace V2PolicyRuleRuleAttribute {
        namespace Constants {
            /** The operator of an attribute. */
            enum Operator {
                TIMELESSTHAN = "timeLessThan",
    ...
    /** Rule that specifies additional access granted (e.g., time-based condition) accross multiple conditions. */
    interface V2PolicyRuleRuleWithNestedConditions extends V2PolicyRule {
        /** Operator to evaluate conditions. */
    ...
    namespace V2PolicyRuleRuleWithNestedConditions {
        namespace Constants {
            /** Operator to evaluate conditions. */
            enum Operator {
                AND = "and",
